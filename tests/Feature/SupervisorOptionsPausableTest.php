...
class SupervisorOptionsPausableTest extends IntegrationTest
{
    public function test_dynamic_property_warning_from_worker_pausable()
    {
        ...
        $this->expectDeprecationMessageMatches('/Creation of dynamic property .*SupervisorOptions::\$pausable/');
    }
}
